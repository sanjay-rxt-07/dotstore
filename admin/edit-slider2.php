...
<body>
    ...
    if (isset($_GET['sliderId'])) {
            ...
            if (isset($_POST['submit'])) {
                ...
                try {
                    if (!empty($posterFileName)) {
                        ...
                        $query = "UPDATE slider2 SET name='$name', image='$posterFilePath', url='$url' WHERE id='$id'";
                    } else {
                        // If no new image is uploaded, update only the name
                        $query = "UPDATE slider2 SET name='$name',url='$url' WHERE id='$id'";
                    }
        ...
        $query = "SELECT * FROM slider2 WHERE id='$id'";
           ...
           <div class="container-fluid pt-4 px-4">
            <div class="col-sm-12 ">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Edit Mid Slider</h6>

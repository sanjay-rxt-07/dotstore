...
<head>
    <meta charset="utf-8">
    <title>Admin-DotStore-FAQs Manager</title>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">All FAQs</h6>
                        <a href="add-faq.php" class="btn btn-sm btn-primary">Add FAQs</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php 
                                $maincate_query="SELECT * from faq";
                                 ;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-faq.php?faqId=<?php echo $id; ?>"><button class="btn-info">Edit</button></a>
...
<script>
    function confirmRedirect() {
        ...
        if (result) {
            window.location.href = "delete-product.php?faq=<?php echo $id; ?>"; 
        }

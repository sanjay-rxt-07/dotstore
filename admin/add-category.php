           ...
           <div class="container-fluid pt-4 px-4">
            <div class="col-sm-12 ">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add Main Category</h6>
...
if(isset($_POST['submit'])){
    ...
    try {
        $query="insert into category (name,image,head) value ('$name','$posterFilePath','$head')";
...
?>
                            ...
                            <form  method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                <label for="head" class="col-sm-2 col-form-label">In Headsection</label>
                                <div class="col-sm-10">
                                <select class="form-select mb-3" aria-label="Default select example" name="head" required>
